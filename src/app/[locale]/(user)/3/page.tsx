...
export default function HomePage() {
  ...
  const [question, setQuestion] = useState({
    title: t("video3question1Title"),
    selectAnswer: t("video3question1SelectAnswer"),
    answer1: t("video3question1Answer1"),
    answer2: t("video3question1Answer2"),
    answer3: t("video3question1Answer3"),
    answer4: t("video3question1Answer4"),
    correctAnswer: t("video3question1CorrectAnswer"),
    correctFeedback: t("video3question1CorrectFeedback"),
    incorrectFeedback: t("video3question1IncorrectFeedback"),
    continueButton: t("video3question1ContinueButton"),
    number: 1,
  });
  ...
  useEffect(() => {
    ...
    const videoStops = [125]; // 2:05 in seconds
    let ytPlayerSpeed = 1;
  ...
  const handleChangeQuestion = (questionNumber: number) => {
    setQuestion({
      title: t(`video3question${questionNumber}Title`),
      selectAnswer: t(`video3question${questionNumber}SelectAnswer`),
      answer1: t(`video3question${questionNumber}Answer1`),
      answer2: t(`video3question${questionNumber}Answer2`),
      answer3: t(`video3question${questionNumber}Answer3`),
      answer4: t(`video3question${questionNumber}Answer4`),
      correctAnswer: t(`video3question${questionNumber}CorrectAnswer`),
      correctFeedback: t(`video3question${questionNumber}CorrectFeedback`),
      incorrectFeedback: t(`video3question${questionNumber}IncorrectFeedback`),
      continueButton: t(`video3question${questionNumber}ContinueButton`),
      ...
      <main className="bg-white">
        ...
        >
                ...
                >
                  <div className="mx-auto w-full portrait:w-1/2 lg:w-full">
                    <div className="relative pt-1/1 h-0">
                      ...
                      >
                        <source
                          src={`/images/3.${question.number}.1.mp4`}
                          type="video/mp4"
                        />
                      </video>
                      <video
                      ...
                      >
                        <source
                          src={`/images/3.${question.number}.2.mp4`}
                          type="video/mp4"
                        />
                      </video>
                      <video
                      ...
                      >
                        <source
                          src={`/images/3.${question.number}.3.mp4`}
                          type="video/mp4"
                        />
                      </video>
                      {question.answer4 != "" && (
                        ...
                        >
                          <source
                            src={`/images/3.${question.number}.4.mp4`}
                            type="video/mp4"
                          />
                        </video>
                      )}
          ...
          <div className="mt-4 md:flex gap-x-4 text-center">
            ...
            <Link href="/2" className="relative inline-block w-full">
              <Image
