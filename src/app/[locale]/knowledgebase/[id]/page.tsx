...
// function BlogContent({ content, images, locale }: { content: Record<string, string>; images: string[]; locale: string }) {
//   let langContent = "";
//   try {
...
//     if (!id) return;
//     axios
//       .get(`${process.env.NEXT_PUBLIC_API_URL}/blogs/${id}`)
//       .then((res) => {
//         setBlog(res.data);
//         setLoading(false);
//       })
...
//     <div className="knowledgebase pt-48 max-w-screen-lg w-full mx-auto px-4">
//       <div className="max-w-screen-sm w-full mx-auto text-center mb-24">
//         <h1 className="text-2xl font-bold">{t("Admin.blogNotFound")}</h1>
//       </div>
//       <div className="text-center my-24">
//         <Link href="/knowledgebase" className="underline text-sorbifer-dark">
//           {t("Admin.backToList")}
...
//   const title =
//     (blog.title && blog.title[locale] && blog.title[locale].trim() !== "")
//       ? blog.title[locale]
//       : blog.title.ru || blog.title.az || t("Admin.noTitle");
...
//       </div>
//       <div className="text-xl">
//         <BlogContent content={blog.content} images={blog.images} locale={locale} />
//       </div>
//       <div className="text-center my-24">
//         <Link href="/knowledgebase" className="underline text-sorbifer-dark">
//           {t("Admin.backToList")}
